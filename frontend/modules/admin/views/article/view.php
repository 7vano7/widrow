...
$this->params['breadcrumbs'][] = ['label' => Yii::t('admin', 'Article'), 'url' => ['index']];
                    ...
                    <?= DetailView::widget([
                        ...
                        'attributes' => [
                            ...
                            [
                                'attribute' => 'top',
                                'value' => function ($data) {
                                    return \Yii::$app->formatter->load(ArticleFormatter::class)->asTop
                                    ($data->top);
                                },
                                'format' => 'html',
                            ],
                            [
                                'attribute' => 'user_id',
                                'value' => function ($data) {
                                    return \Yii::$app->formatter->load(ArticleFormatter::class)->asUser
                                    ($data);
                                },
                                'format' => 'html',
                            ],
                            [
                                'attribute' => 'gif',
                                'value' => function ($data) {
                                    return \Yii::$app->formatter->load(ArticleFormatter::class)->asGif
                                    ($data);
                                },
                                'format' => 'html',
                            ],
