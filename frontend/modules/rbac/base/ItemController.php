...
namespace frontend\modules\rbac\base;
...
use frontend\modules\rbac\models\AuthItemModel;
use frontend\modules\rbac\models\search\AuthItemSearch;
...
class ItemController extends Controller
{
    ...
    {
       if (!Yii::$app->user->can('access.role.listview')) {
    ...
    {
       if (!Yii::$app->user->can('access.role.create')) {
           throw new ForbiddenHttpException(Yii::t("access rules", "You haven't access to view this page"));
       }
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', Yii::t('rbac', 'Item has been saved.'));
    ...
    public function actionDelete(string $id)
    {
       if (!Yii::$app->user->can('access.role.delete')) {
        ...
        Yii::$app->session->setFlash('success', Yii::t('rbac', 'Item has been removed.'));
    ...
    protected function findModel(string $id): AuthItemModel
    {
        ...
        if (empty($item)) {
            throw new ForbiddenHttpException(Yii::t("rbac", "The requested page does not exist."));
        }
