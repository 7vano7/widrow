...
class BizRuleModel extends Model
{
    ...
    public function classExists()
    {
        if (!class_exists($this->className)) {
            $message = Yii::t('access', "Unknown class '{class}'", ['class' => $this->className]);
        ...
        if (!is_subclass_of($this->className, Rule::class)) {
            $message = Yii::t('access', "'{class}' must extend from 'yii\\rbac\\Rule' or its child class", [
    ...
    public function attributeLabels(): array
    {
        return [
            ...
            'className' => Yii::t('access', 'Class Name'),
        ];
    }
